...
import ar.edu.unju.fi.ejercicio17.model.constantes.Posiciones;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		Posiciones posicionJugador = null;
		...
		do {
			...
			case 1:// alta jugador
				...
				do {
					...
					try {
						...
						posicionJugador = Posiciones.valueOf(posicionString);
			...
			case 3: // jugadores ordenados por apellido
				if (jugadores.isEmpty()) {
					...
					// visualizo jugadores
					jugadores.forEach(jug -> System.out.println("Jugador: " + jug.getApellido()));
				}
				break;
			...
			case 6: // cantidad de jugadores
				if (jugadores.size() == 1) {
					System.out.println("El ArrayList tiene " + jugadores.size() + " jugador.");
				} else {
					System.out.println("El ArrayList tiene " + jugadores.size() + " jugadores.");
				}
				break;
